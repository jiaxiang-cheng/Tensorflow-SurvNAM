...
class ActivationLayer(tf.keras.layers.Layer):
    ...
    def __init__(self,
                 ...
                 activation='exu',
                 trainable=True):
        """Initializes ActivationLayer hyper-parameters.
...
class FeatureNN(tf.keras.layers.Layer):
  ...
  """
    ...
    def __init__(self,
                 ...
                 name_scope='model',
                 activation='exu'):
        """Initializes FeatureNN hyper-parameters.
...
class NAM(tf.keras.Model):
  ...
  """
    ...
    def __init__(self,
                 ...
                 dropout=0.0,
                 **kwargs):
        """Initializes NAM hyper-parameters.
    ...
    def call(self, x, training=True):
        ...
        training = self._true if training else self._false  # training or evaluation mode
        dropout_out = tf.nn.dropout(
            stacked_out,
            rate=tf.cond(training, lambda: self._feature_dropout, lambda: 0.0))
        # if training mode then with dropout
